...
Ext.define('Ext.ux.form.field.CodeMirror', {
    ...
    */
    modes: [{
    	...
    	mime:           ['text/x-sql', 'text/x-mysql', 'text/x-mariadb', 'text/x-cassandra', 'text/x-plsql', 'text/x-mssql', 'text/x-hive'],
    ...
    */
    loadScript: function(options){
        var me = this;
//        Ext.Loader.loadScriptFile(options.url,options.onLoad, options.onError, me,
//				true);
        Ext.Ajax.request({
            url: options.url,
    ...
    */
    getErrors: function(value) {
        ...
        trimmed = value?Ext.String.trim(value):value;
