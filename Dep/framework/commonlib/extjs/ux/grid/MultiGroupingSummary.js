...
//    },
    ...
    // new method for this class
    generateTotalSummaryData: function () {
      var me = this,
        data = {},
        store = me.view.store,
        columns = me.view.headerCt.getColumnsForTpl(),
      ...
      for (i = 0, length = columns.length; i < length; ++i) {
        ...
        data[comp.id] = comp.totalSummaryText ? comp.totalSummaryText : me.getSummary(store,
          (comp.totalSummaryType ? comp.totalSummaryType : comp.summaryType), comp.dataIndex, false);
      }
      return data;
    },
