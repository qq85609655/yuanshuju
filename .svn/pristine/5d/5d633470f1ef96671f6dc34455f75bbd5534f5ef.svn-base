...
*/
Ext.define('Ext.ux.grid.GroupPropertyRecord', {
...
Ext.ux.grid.GroupPropertyStore = function(grid, source){
    this.grid = grid;
    this.store = new Ext.grid.property.Store({
        model : "Ext.ux.grid.GroupPropertyRecord",
		groupField : "group"
    });
...
*/
Ext.ux.grid.GroupPropertyGrid=Ext.extend(Ext.grid.property.Grid,{
