...
Dep.framework.editor.figure.NoBussConnection1 = Dep.framework.editor.figure.BaseConnection
		.extend({
			/**
			 * 类名
			 * 
			 * @type String
			 */
			NAME : "Dep.framework.editor.figure.NoBussConnection1",
			/**
			 * 参见父类
			 */
			DEFAULTROUTER : new draw2d.layout.connection.MetadataSplineConnectionRouter,
			/**
			 * 参见父类
			 */
